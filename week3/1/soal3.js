...
2. powerMe, yang menerima dua parameter berupa num1 dan num2. Function tersebut akan memangkatkan num1 dengan num2 (num1 ^ num2) dan mereturn hasil perpangkatannya.
  contoh
  ------
  input: powerMe(2, 3)
  output: 8
